...
const initialDestinations = [
  ...
  { id: '8', title: 'North Bay Island Coral Safari', location: 'North Bay, Andaman', price: 8000, rating: 4.8, image: 'https://images.unsplash.com/photo-1518020382113-a7e8fc38eac9?auto=format&fit=crop&w=800&q=80', category: 'Adventure', description: 'Walk on the sea floor with a helmet dive or try glass-bottom boat rides over stunning coral reefs.' }
];
